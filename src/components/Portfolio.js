...
const projects = [
    {
      title: 'MyHealthSpace',
      description: 'Full-Stack web application using MERN, GraphQL, and React.',
    ...
    {
      title: 'ShelfSwap',
      description: 'Full-Stack web application using MERN, GraphQL, React, and MaterialUI',
      imageSrc: 'shelf-swap.jpg',
      deployedLink: 'https://shelf-swap-425acc537cee.herokuapp.com/',
      githubLink: 'https://github.com/Jalzu1007/ShelfSwap.git'
    },
    {
      title: 'BookMark',
